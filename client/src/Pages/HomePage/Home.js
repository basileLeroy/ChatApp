    ...
    return (
        ...
        <div className="flex flex-col text-blue-naval">
            ...
            <div className="flex flex-row h-auto z-0">
                    ...
                    <form action="/chats" method="post" onSubmit={handleLogIn}>
                        ...
                        <div className="flex flex-row my-6 justify-around">
                            <button type="submit" className="text-brown-white hover:underline bg-brown-yellow rounded-br-lg rounded-tl-lg p-3 2xl:text-lg 2xl:p-4 mb-3" onClick={handleLogIn}>Register</button>
                        </div>
                    </form>
                    </div>
                </div>
